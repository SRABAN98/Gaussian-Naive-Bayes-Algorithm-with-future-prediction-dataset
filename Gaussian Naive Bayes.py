...
#split the dataset into D.V and I.V
...
#training the Bernoulli Naive Bayes algorithm into the training set
...
#This is to get the Model's Accuracy
...
y_pred_GaussianNB = pd.DataFrame()

d2["y_pred_GaussianNB"] = classifier.predict(M)


#save the future prediction dataframe as the .csv file format
d2.to_csv("FPofGaussianNBAlgo.csv")
